...
public class StateMachineInitializer {
    ...
    private Map<String, StateExample> states = new HashMap<>();
...
//        PAGE_IPV_START.withEvent(
//                new BasicEvent("next", CRI_UK_PASSPORT, new CriResponse("cri/start/uk-passport")));
//        CRI_ADDRESS.withEvent(
//                new BasicEvent("next", CRI_ADDRESS, new CriResponse("cri/start/address")));
//        CRI_FRAUD.withEvent(
//                new BasicEvent("next", PAGE_KBV_TRANSITION, new PageResponse("kbv-transition")));
//        PAGE_KBV_TRANSITION.withEvent(
//                new BasicEvent("next", CRI_KBV, new CriResponse("cri/start/kbv")));
//        CRI_KBV.withEvent(new BasicEvent("next", CRI_KBV, new CriResponse("cri/start/kbv")));
//        PAGE_SUCCESS.withEvent(
//                new BasicEvent("next", SESSION_END, new JourneyResponse("session/end")));
